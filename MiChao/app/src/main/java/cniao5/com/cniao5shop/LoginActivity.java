...
//        params.put("password", DESUtil.encode(Contants.DES_KEY, pwd));
        Map<String,Object>param = new Hashtable<>(2);
        param.put("phone",phone);
        param.put("password",DESUtil.encode(Contants.DES_KEY,pwd));

        okHttpHelper.post(Contants.API.LOGIN, param, new SpotsCallBack<LoginRespMsg<User>>(this) {
